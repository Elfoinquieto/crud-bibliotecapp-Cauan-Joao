        ...
        <div class="col-md-8">
            ...
            <div class="row mb-3">
                ...
                <div class="col text-end">
                    <a href="{{ route('listarLivros') }}" class="btn btn-outline-danger">
            ...
            <form action="{{ isset($book) ? route('atualizarLivro', $book->id) : route('salvarLivro') }}" method="post">
                @csrf
                @if(isset($book))
                    @method('PUT')
                @endif
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-dark text-white border-secondary" name="title" value="{{ old('title', $book->title ?? '') }}">
                    @error('title')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-dark text-white border-secondary" name="isbn" value="{{ old('isbn', $book->isbn ?? '') }}">
                        @error('isbn')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control bg-dark text-white border-secondary" name="description" rows="4">{{ old('description', $book->description ?? '') }}</textarea>
                    @error('description')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row mt-4">
                    <div class="col text-end">
                        <a href="{{ route('listarLivros') }}" class="btn btn-secondary px-4 me-2">
